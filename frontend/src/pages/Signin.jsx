  ...
  return (
    <div
      ...
      style={{backgroundImage: `url(${bg})`}}>
        ...
        <form className='w-[90%] h-[600px] max-w-[500px] backdrop-blur shadow-lg shadow-black bg-[#00000062] flex items-center justify-center flex-col gap-[20px] px-[20px]' onSubmit={handleSignIn}>

            <h1 className='mb-[30px] text-white font-semibold text-[30px]'>
                Sign In to <span className="text-blue-800">Nexa</span></h1>
                ...
                <button className="text-[19px] mt-[30px] text-black font-semibold min-w-[150px] h-[60px] bg-white rounded-2xl" disabled={loading}>{loading?"Loading...":"Sign In"}</button>

                <p className="text-[white] cursor-pointer text-[18px]" onClick={() => navigate("/signup")}>Want to create new account ? <span className="text-blue-500">Sign Up</span></p>
        </form>
    </div>
  );
};
